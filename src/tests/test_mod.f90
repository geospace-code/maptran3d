...
call assert_allclose([e,n,u], [east, north, up], atol=atol_dist)
...
call assert_allclose([ee,n,u], [east, north, up])
...
call assert_allclose([e, n, u], [east, north, up])
...
call assert_allclose(olat, lat, err_msg='lookAtSpheroid:lat0')
call assert_allclose(olon, lon, err_msg='lookAtSpheroid:lon0')
call assert_allclose(orng, alt, rtol=0.01_wp, err_msg='lookAtSpheroid:rng0')

call lookAtSpheroid(lat, lon, alt, az, tilt, olat, olon, orng)
call assert_allclose(olat, [42.00103959_wp, 42.00177328_wp, nan],  equal_nan=.true., err_msg='lookAtSpheroid:lat')
call assert_allclose(olon, [lon, -81.9995808_wp, nan],  equal_nan=.true., err_msg='lookAtSpheroid:lon')
call assert_allclose(orng, [230.9413173_wp, 282.84715651_wp, nan], rtol=0.01_wp, equal_nan=.true., err_msg='lookAtSpheroid:rng')
...
call assert_allclose([x, y, z],[x0,y0,z0], err_msg='geodetic2ecef-degrees1')

call geodetic2ecef(0._wp, 0._wp, -1._wp, x, y, z)
call assert_allclose([x, y, z], [ea-1, 0._wp, 0._wp], err_msg='geodetic2ecef-degrees2')

call geodetic2ecef(0._wp, 90._wp, -1._wp, x, y, z)
call assert_allclose([x, y, z], [0._wp, ea-1, 0._wp], err_msg='geodetic2ecef-degrees3')

call geodetic2ecef(0._wp, -90._wp, -1._wp, x, y, z)
call assert_allclose([x,y,z], [0._wp, -ea+1, 0._wp], err_msg='geodetic2ecef-degrees4')

call geodetic2ecef(0._wp, -180._wp, -1._wp, x, y, z)
call assert_allclose([x,y,z], [-ea+1, 0._wp, 0._wp], atol=atol_dist, err_msg='geodetic2ecef-degrees5')
call geodetic2ecef(0._wp, 180._wp, -1._wp, x, y, z)
call assert_allclose([x,y,z], [-ea+1, 0._wp, 0._wp], atol=atol_dist, err_msg='geodetic2ecef-degrees6')

call geodetic2ecef(90._wp, 0._wp, -1._wp, x, y, z)
call assert_allclose([x,y,z], [0._wp, 0._wp, eb-1], err_msg='geodetic2ecef-degrees7')

call geodetic2ecef(-90._wp, 0._wp, -1._wp, x, y, z)
call assert_allclose([x,y,z], [0._wp, 0._wp, -eb+1], err_msg='geodetic2ecef-degrees8')

call geodetic2ecef(90._wp, 15._wp, -1._wp, x, y, z)
call assert_allclose([x,y,z], [0._wp, 0._wp, eb-1], err_msg='geodetic2ecef-degrees9')
